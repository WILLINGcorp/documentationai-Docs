...
You select an account type during signup. This choice controls which dashboards, workflows, and tools you see first, but you can usually add or upgrade to other account types as your work grows. If you sign up using "Continue with GRABBYS," you will see a dedicated account type selection screen before onboarding begins. Enterprise accounts are not yet available — selecting Enterprise on this screen opens a waitlist form so the ModelBoard team can contact you when they become available.
...
Enterprise accounts are currently under development and not yet available. If you select Enterprise during signup, you will be asked to join a waitlist with your company name, contact details, and the features you need. A dedicated account manager will reach out when Enterprise accounts become available. For tailored guidance on Agency, Holding, or Platform structures, contact ModelBoard sales or support.
