...
Ideal for independent creators and adult film stars who need a public creator profile, portfolio, and simple collaboration tools to manage their careers.

</Card>

<Card title="Business" href="#business" icon="briefcase" cta="View details">

Designed for companies, freelancers, and service providers that need a discoverable business presence and collaboration workflows with talent and studios.
...
Best for production studios and labels that manage public studio visibility, casting, model applications, credits, and production call sheets across multiple shoots.
...
Explore how each account type approaches profiles, projects, discovery, compliance, and production workflows.
...
<Tabs>
  ...
  **Model accounts** focus on your personal brand, credits, and collaborations as an individual creator.
  ...
  - **Core focus**: Build a public creator profile, show your portfolio and credits, set collaboration preferences, and join projects with studios and businesses.

  **Typical tools and views**

  - **Public creator profile and portfolio** to highlight your experience, media, specialties, preferences, and industry credits.
  ...
  **Business accounts** center on client work, services, and recurring collaborations with creators and studios.
  ...
  - **Core focus**: Manage projects, client relationships, and collaborations while keeping a public business presence in the network.
  ...
  **Typical tools and views**
  ...
  - **Casting and talent search** to discover onboarded creators and studios to work with on campaigns or productions.
  ...
  **Studio accounts** anchor around casting, scheduling, credits, and studio visibility across your productions.

  - **Who it is for**: Production studios, labels, and production teams that run shoots, manage crews, and credit participants.
  - **Core focus**: Handle casting, production logistics, public studio positioning, and credits while coordinating with models and businesses.
...
## Studio signup choices

Studio registration now starts by choosing whether you are creating a new studio or joining an existing organization. This choice affects the username format, ownership, and which organization profile your account belongs to.

<Tabs>

  <Tab title="Create New Studio" icon="monitor">

  Choose this path when you are registering a new studio account and should become its owner.

  - Enter the studio handle that represents the organization.
  - Enter the owner username for your personal account inside that studio.
  - Review the full username preview before continuing.

  </Tab>

  <Tab title="Join Existing Studio" icon="users">

  Choose this path when a studio already exists on ModelBoard and you need to join it as a team member.

  - Search for the organization by name or handle.
  - Select the correct studio from the search results.
  - Enter your username after the organization is selected.
...
Studio handles and usernames cannot be changed after submission. Confirm the handle, organization, and username on the final review step before creating the account.
...
Model accounts are built around showcasing you as talent and connecting you with verified industry partners through public discovery and collaboration workflows.

### What a Model account is designed for

A Model account is best when you:

- Want a **central, public creator profile** that studios and businesses can trust.
- Need to **showcase your portfolio, collaboration preferences, and industry credits** in a professional way.
...
- Updating your **profile, portfolio, preferences, and credits** so they reflect your most recent work and the opportunities you want.
...
- Using **casting and talent tools** to find onboarded creators, studios, or service partners that match your project requirements.
...
- Want a **public studio listing** that helps creators and businesses understand your productions and brand.
...
- **Model**: Focused on your public creator profile, portfolio, preferences, and credits, so studios and businesses can evaluate you quickly.
- **Business**: Highlights services, past collaborations, and selected clients in a discoverable business presence.
- **Studio**: Emphasizes productions, titles, and the talent you have worked with through studio listings and catalogs.
...
- **Model**: Public profile visibility for inbound discovery by studios, agencies, and businesses; respond to casting opportunities.
- **Business**: Talent and studio discovery to staff campaigns, services, and partner work.
- **Studio**: End-to-end casting management, from public calls and creator discovery to application review and selection.
