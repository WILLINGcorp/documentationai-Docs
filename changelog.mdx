...
<Columns cols={3}>
  ...
  <Card title="v1.3.1" icon="shield" href="#v1-3-1">

    Security hardening and presence stability fixes.
...
<Update label="2026-07-15" description="v1.3.1" tags={["security", "bugfix"]}>

## Security Improvements

- Staff members can no longer change their own permissions, role, or activation status. Only organization owners or platform administrators can modify these fields.
...
- Sub-account requests and sub-account lists are now restricted to members of the relevant organization.
- Creator rating details are now visible only to direct participants and platform administrators. Public viewers see aggregate information only.

## Bug Fixes

- Fixed real-time presence channel leaks that could cause stale connections and degraded reliability in online presence and pro-status indicators.
...
|---------|--------------|-------------|------|
| v1.3.1 | 2026-07-15 | Security hardening, presence fixes | security, bugfix |
