...
description: Use Collabs projects in ModelBoard to propose work, invite collaborators with permissions, manage assets, and track project status from pending to archived.
---
