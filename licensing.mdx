...
title: Licensing
description: >-
  Understand the Collab Licensing tab, what is live today, and what the planned
  LicenseGenerationForm wizard will capture for distribution-ready usage rights.
---
...
The Licensing tab in a Collab project describes how approved assets may be used. It captures the rights, usage terms, and authorized platforms that govern distribution.

<Callout kind="info" collapsed="false">
  Licensing terms are defined during the project and applied at distribution. Prepare early even if the feature is still in development.
</Callout>

## When to update it

- **When licensing terms are negotiated**: Update the tab whenever rights, usage scope, or platforms are discussed or agreed upon.
- **When assets are approved for distribution**: Confirm licensing terms before any file moves to delivery.
- **When new platforms are authorized**: Add platforms as they are approved and remove any that are rescinded.
- **When usage rights change**: Update if exclusivity, territory, or duration terms shift during the project.
- **Before distribution**: Verify all licensing terms are finalized and documented before any asset is shared externally.

## What to include

- **License type**: The category of license, such as exclusive, non-exclusive, commercial, or editorial, applied to the asset.
- **Authorized platforms**: Platforms or channels where the asset is permitted to be distributed or displayed.
- **Usage rights**: How the asset may be used, including distribution, modification, sublicensing, commercial use, and derivative works.
- **Rights holders**: Individuals or entities who own or control the rights being licensed.
- **Commercial terms**: License fees, revenue sharing percentages, and payment structure.
- **Duration and expiration**: When the license starts, how long it lasts, and when it expires or renews.

## Best practices

- **Define terms early**: Even if the Licensing feature is in development, negotiate and document terms during the project, not after.
- **Be specific about platforms**: List exact platforms by name rather than using generic categories like "social media."
- **Track exclusivity carefully**: If an asset is licensed exclusively, ensure no other distribution channel conflicts with the exclusivity terms.
- **Document rights holders explicitly**: Every rights holder should be named with their contribution and rights share.
- **Verify before distribution**: No asset should leave the Collab project without confirmed licensing terms.

## Role-specific guidance

<Tabs>
  <Tab title="Project owner (sender)" icon="user">
    You are responsible for negotiating and documenting all licensing terms. Define rights holders, authorized platforms, and usage scope before the project reaches distribution. Verify that every approved asset has confirmed licensing before delivery.

    Use the [Compliance](/compliance) tab to ensure all releases and verification records support the license terms you grant.
  </Tab>

  <Tab title="Collaborator (receiver)" icon="users">
    Your role is to ensure your work complies with the licensing terms defined in this tab. If you are a rights holder, confirm your rights share is documented correctly. Flag any unclear or missing terms to the project owner before the project reaches distribution.
  </Tab>
</Tabs>
...
- **non\_exclusive** — You may license the same content to multiple licensees at the same time.
...
- **commercial\_use** — Commercial Use: right to use for commercial purposes.
- **derivative\_works** — Derivative Works: right to create derivative works.
...
<ParamField body="licensee_name" param-type="string" required="true" deprecated="false" show-location="false">
  Legal or business name of the licensee who will receive rights to the content.
</ParamField>

<ParamField body="licensee_contact_email" param-type="string" required="true" deprecated="false" show-location="false">
...
<ParamField body="authorized_platforms" param-type="array<string>" required="true" deprecated="false" show-location="false">
...
<ParamField body="start_date" param-type="date" required="true" deprecated="false" show-location="false">
  Date the license becomes effective. Usage before this date is outside the license scope.
</ParamField>

<ParamField body="license_duration_months" param-type="integer" required="false" deprecated="false" show-location="false">
...
<ParamField body="usage_rights" param-type="record<string, boolean>" required="false" deprecated="false" show-location="false">
...
<ParamField body="license_type" param-type="enum" required="true" deprecated="false" show-location="false">
...
<ParamField body="license_fee_amount" param-type="integer" required="false" deprecated="false" show-location="false">
...
<ParamField body="revenue_sharing_percentage" param-type="number" required="false" deprecated="false" show-location="false">
...
- Specify the **license type** (for example, non\_exclusive or commercial)
...
<ExpandableGroup>
  ...
  <Expandable title="Will the Licensing tab replace my legal contracts?" default-open="false">
  ...
  <Expandable title="How will Licensing relate to Compliance and File Sharing?" default-open="false">
  ...
  <Expandable title="Can I track different licenses for the same content?" default-open="false">
  ...
  <Expandable title="How should I get ready for Licensing now?" default-open="false">
