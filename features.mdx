...
<Columns cols="2">
  ...
  <Card title="Industry Network" href="/networking" icon="lucide-network" cta="Discover Grid & Directories" horizontal="false" target="_self">
    Discover Models, or Browse our Studio or Business Directories.
  </Card>
</Columns>
...
<Steps>
  ...
  <Step title="Verify Identity" icon="check-circle" title-type="p">
  ...
  <Step title="Publish Profile" icon="globe" title-type="p">
...
<Expandable title="Integration Example" default-open="false">
