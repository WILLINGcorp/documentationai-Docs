...
<Step title="Review automated 2257 signature authorization" icon="lock" title-type="p">
...
<Step title="Generate and download the fully signed release form" icon="download" title-type="p">
...
<ParamField body="release-pdf-action" param-type="enum" show-location="false">
...
<ParamField body="automated-2257-signature-authorization" param-type="boolean" show-location="false">

Indicates whether the collaborator authorized ModelBoard to apply automated 2257 signatures for eligible records. Collaborators grant this during verification and can revoke it later from account settings.

</ParamField>

<ParamField body="automated-2257-signature-activity" param-type="log" show-location="false">
...
<ParamField body="project-qr-scan-history" param-type="log" show-location="false">
...
<Expandable title="A collaborator revoked automated 2257 signature authorization. What changes?">
