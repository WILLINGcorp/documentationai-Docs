...
<Callout kind="info" collapsed="false">
  If you leave setup before finishing every step, return to your dashboard and look for the **Resume Setup** banner. Use it to continue from the remaining onboarding items instead of starting over.
</Callout>
