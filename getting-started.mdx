...
description: >-
  Set up your ModelBoard account, choose the right account type, and complete a
  practical first-day checklist to get ready for collaborations.
---
...
<Tabs>
  ...
  <Tab title="Business" icon="briefcase">
    - Brands, Freelancers, and Service Providers

    - Get listed in our Business Directory

    - Advertise your Services & Products to Industry insiders

    - List, Manage & Promote your Industry Event&#x20;

    - Find brand ambassadors among our models
  </Tab>
...
<Steps>
  ...
  <Step title="Start verification and compliance" icon="shield" title-type="p">
    ...
    **What to do**
    ...
    - Enter any required identity details, including your date of birth and document expiration date, using the dropdown fields

    - Upload the primary documents requested, such as ID, business registration, or studio or agency paperwork

    - If you take document photos on your phone, keep your ID upright in portrait orientation and fully inside the crop frame
...
<Steps>
  ...
  <Step title="Upload required verification docs" icon="shield" title-type="p">
    ...
    - Enter any requested identity dates from the dropdown lists before you submit your documents

    - Upload at least the primary document set (ID or registration)

    - If you use mobile capture, keep your ID upright and fully inside the frame
