...
<Callout kind="info" collapsed="false">
  ...
  **Signing up with GRABBYS?** If you create your account using "Continue with GRABBYS," you will see a dedicated account type selection screen before onboarding begins. Choose Content Creator, Business, or Studio to proceed to onboarding. Enterprise accounts are not yet available — selecting Enterprise opens a waitlist form so the ModelBoard team can contact you when they become available.
