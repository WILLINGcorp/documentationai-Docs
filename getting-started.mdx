...
<Tabs>
  <Tab title="Model" icon="users">
    ...
    - Use compliance workflows to support required verification, releases, consent records, and 2257-related documentation for collaborations
    ...
    - Customize a public Link-in-Bio profile and get listed through Model Discovery when your visibility settings allow it
  </Tab>
