...
title: Portfolios
description: >-
  Structure focused portfolios that showcase your best work, connect them to
  your creator profile, and use them inside collaboration projects.
---
...
Portfolio and album visibility are separate decisions. An album is not automatically exposed to every unauthenticated visitor or broad profile viewer because it exists inside a portfolio. Before you expect an album to appear publicly, confirm that the portfolio or album is intentionally set for public access and that the content is appropriate for that audience.
...
<Expandable title="My public portfolio or album is not visible to viewers">

If unauthenticated visitors or broad profile viewers cannot see a portfolio or album, first confirm that the content is meant to be public. Tightened album access means albums are only shown when their visibility and placement allow that audience to view them.

- Open the portfolio or album from your creator dashboard and review its **visibility** setting.
- Confirm the portfolio is connected to the public profile area where you expect viewers to find it.
- Use a signed-out browser window or private browsing session to check what an unauthenticated visitor can see.
- If the album should stay private, share it through a link-only or restricted workflow instead of changing it to public.
