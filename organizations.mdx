...
title: Organizations
description: >-
  Understand how organizations, sub-accounts, roles, and account switching work
...
Staff members cannot change their own permissions, activation status, or role. Only organization owners or platform administrators can modify these fields for a staff account.
...
- Staff members cannot modify their own permissions, role, or activation status — only organization owners or platform administrators can make those changes.
- Join requests cannot be self-approved by the requester. Only the relevant organization owner can approve or reject a pending request.
- Users can only view sub-account requests and sub-account lists for organizations they belong to.
