...
description: >-
  Use the Overview tab in a Collab project as the single source of truth for
  goals, scope, and timing so invitees and collaborators share the same context.
---
## Purpose
...
- **Ownership Scope**\
  The copyright ownership choice shown in the project Overview UI, especially when collaborators need to understand how derivative work ownership is framed before they accept.

Keep descriptions specific enough that someone unfamiliar with your internal context can still make an informed decision.

## Ownership Scope dialog

Use the Ownership Scope dialog to review how ModelBoard frames copyright ownership for derivative work created through the Collab project. You can open it from the Overview tab near the ownership information shown for the project.

The dialog explains that a collaboration includes some form of shared ownership by definition. If the project requires exclusive ownership, ModelBoard directs you to use the Production Workflow instead of the standard Collab project workflow.

<Callout kind="alert" collapsed="false">
  ModelBoard guidance in this dialog helps collaborators understand the workflow and ownership scope selected for the project. It is not legal advice. Review the Licensing tab and your own agreements when ownership, usage, or distribution rights need formal confirmation.
</Callout>

Creator accounts also see an upgrade warning when exclusive ownership or the Production Workflow is required. The warning explains that you need a Studio Pro account to use the Production Workflow and should contact Support to request an account type migration.

### Ownership choices

The dialog shows three ownership options. Use the choice that best matches how the project is produced and who should share in ownership.

- **Collab with Shared Ownership**\
  Use this when performers self-produce the project and share ownership between the performers collaborating in the project.
- **Indie with Shared Ownership**\
  Use this when an indie label, videographer, or production hub produces the project and ownership is shared between all collaborators, including performers and other contributors.
- **Sponsored with Ownership Transfer**\
  Use this when a sponsor such as a content house or private label receives ownership transfer, while performers and their distributors receive a perpetual commercial distribution license. Review the Licensing tab for the project-specific details attached to this choice.
...
<Steps>
  <Step title="Set up the Overview before inviting collaborators" icon="edit" title-type="p">
  ...
  <Step title="Share with collaborators and gather alignment" icon="share-2" title-type="p">
  ...
  <Step title="Maintain the Overview during the project" icon="settings" title-type="p">
  ...
  <Step title="Add a closeout summary at completion or archive" icon="check-circle" title-type="p">
...
<Columns cols="3">
  ...
  <Card title="Compliance" href="/compliance" icon="shield" cta="Review requirements" horizontal="false">
